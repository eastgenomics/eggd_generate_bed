...
@pytest.fixture
def t_beds_path(tmp_path:Path) -> Path:
    beds_path=tmp_path / "test_beds"
    beds_path.mkdir(parents=True,exist_ok=True)
    return beds_path
...
class TestGenerateBed:
    ...
    def test_bed(self,test_new_exons,test_expected_bed,t_beds_path):
        """
        ...
        gb.generate_bed(exons=self.read_in_exons_file(test_new_exons),
        ...
        output_prefix=f"{t_beds_path}/test_R50.1_Early_onset_dementia",
        flank=None,
        additional_regions=None)

        #get expected and test bed files path
        expected_bed_file=test_expected_bed
        test_bed_file=f"{t_beds_path}/test_R50.1_Early_onset_dementia_b38.bed"
    ...
    def test_bed_with_flank(self,test_new_exons,test_expected_bed_with_flank,t_beds_path):
        """
        ...
        genes=["HGNC:10000",
	           ...
	           "HGNC:93010"],
        genome_build="_b38.bed",
        output_prefix=f"{t_beds_path}/test_R50.1_Early_onset_dementia_with_flank",
        flank=400,
        additional_regions=None)

        #get test and expected bed file paths

        expected_bed_file=test_expected_bed_with_flank
        test_bed_file=f"{t_beds_path}/test_R50.1_Early_onset_dementia_with_flank_400bp_b38.bed"
    ...
    def test_bed_with_additional_regions(self,test_new_exons,
                                         test_new_additional_regions,
                                         test_expected_bed_with_additional_regions,
                                         t_beds_path):
        """
        ...
        file_name=test_new_additional_regions,
        sep="\t",
        ...
        genes=["HGNC:10000",
	           ...
	           "HGNC:93010"],
        genome_build="_b38.bed",
        output_prefix=f"{t_beds_path}/test_R50.1_Early_onset_dementia_with_additional_regions",
        flank=None,
        additional_regions=additional_regions)
        
        # get expected and test file paths

        expected_bed_file=test_expected_bed_with_additional_regions
        test_bed_file=f"{t_beds_path}/test_R50.1_Early_onset_dementia_with_additional_regions_b38.bed"
    ...
    def test_bed_with_additional_regions_and_flank(self,test_new_exons,
                                                   test_expected_bed_with_additional_regions_flank,
                                                   test_new_additional_regions,
                                                   t_beds_path):
        """
        ...
        genes=["HGNC:10000",
	           ...
	           "HGNC:93010"],
        genome_build="_b38.bed",
        output_prefix=f"{t_beds_path}/test_R50.1_Early_onset_dementia_with_additional_regions_and_flank",
        flank=400,
        additional_regions=additional_regions)
        
        # get expected and test file paths
        
        expected_bed_file=test_expected_bed_with_additional_regions_flank
        test_bed_file=f"{t_beds_path}/test_R50.1_Early_onset_dementia_with_additional_regions_and_flank_400bp_b38.bed"
